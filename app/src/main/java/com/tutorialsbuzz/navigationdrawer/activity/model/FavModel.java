...
public class FavModel implements Serializable
{
    ...
    public FavModel(String id, String topic, String description, String date, String created_by, String likes, String favourite, String islikes)
    {
    ...
    public FavModel(String id, String topic, String description, String date, String created_by, String likes)
    {
    ...
    public FavModel(String reply_id, String reply, String created_by_reply, String date_reply, String idd)
    {
    ...
    public FavModel(String commentCount){
